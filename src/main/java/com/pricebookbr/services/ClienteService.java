...
import com.pricebookbr.dto.ClienteDTO;
import com.pricebookbr.dto.ClienteNewDTO;
import com.pricebookbr.repositories.ClienteRepository;
import com.pricebookbr.security.UserSS;
import com.pricebookbr.services.exceptions.AuthorizationException;
...
public class ClienteService {
	...
	public Cliente fromDTO(ClienteDTO objDto) {
		return new Cliente(objDto.getId(), objDto.getNome(), objDto.getEmail(), 
				//null, null, 
				null, new Date(), objDto.getSituacaoImagem());
	}
	...
	public Cliente fromDTO(ClienteNewDTO objDto) {
		Cliente cli = new Cliente(null, objDto.getNome(), objDto.getEmail(), 
				...
				pe.encode(objDto.getSenha()), new Date(), objDto.getSituacaoImagem());
	...
	public java.net.URI uploadProfilePicture(MultipartFile multipartFile) {		
		UserSS user = UserService.authenticated();
		if (user == null) {
			throw new AuthorizationException("Acesso negado");
		}
		...
		String fileName = prefix + user.getId() + ".png"; // .jpg
...
//		return s3Service.uploadFile(imageService.getInputStream(jpgImage, "jpg"), fileName, "image");
	...
	public void uploadFile(String localFilePath) {
		//try {
			...
			//MultipartFile multipartFile = new Mult
		//}
	}
}