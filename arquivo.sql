...
--
-- Host: localhost    Database: tilapiasdfdb
-- ------------------------------------------------------
...
INSERT INTO `categoria` VALUES (1,'Peixes disponíveis para venda.','Peixes'),(2,'Iguarias da roça para todos os gostos.','Coisas da Roça');
...
INSERT INTO `cidade` VALUES (1,'Brasília',1),(2,'Riacho Fundo',1),(3,'Candangolândia',1),(4,'Samambaia',1),(5,'Guará',1),(6,'São Sebastião',1),(7,'Ceilândia',1),(8,'Lago Norte',1),(9,'Sobradinho',1),(10,'Lago Sul',1),(11,'Gama',1),(12,'Santa Maria',1),(13,'Taguatinga',1),(14,'Planaltina',1),(15,'Recanto das Emas',1),(16,'Cruzeiro',1),(17,'Brazlândia',1),(18,'Paranoá',1),(19,'Núcleo Bandeirante',1);
...
INSERT INTO `cliente` VALUES (1,'36378912377','tilapias.df@gmail.com','Ronald Silva','$2a$10$1R4Qw3FW5zSUtPNtEeKUEu29UQuIqS4UpWlbQj/Yjh.SOf7ZqdBi.',1),(2,'64760537104','asoares73@gmail.com','Alexandre Soares de Almeida','$2a$10$TVdOgNEr5P0pBIi/6wKtku2etPV/f3ru1p41wqg65d433C1/msXcy',1);
...
INSERT INTO `endereco` VALUES (1,'Jardim','38220834','Apto 303','Rua Flores','300',1,1),(2,'Centro','38777012','Sala 800','Avenida Matos','105',2,1),(3,'Guará II','71060042','casa','QE 28 conjunto D','26',5,2);
...
CREATE TABLE `pedido` (
  ...
  `situacao_entrega` int(11) DEFAULT NULL,
  `cliente_id` int(11) DEFAULT NULL,
...
INSERT INTO `produto` VALUES (1,'Peça fresca de tilápia inteira limpa, sem escamas, sem visceras e sem barbatanas. Venda por Kg.','Tilápia Inteira',10),(2,'Postas frescas de tilápia. Venda por Kg.','Postas de Tilápia',13),(3,'Filés frescos de tilápia. Venda por Kg.','Filé Tilápia',30),(4,'Queijo de minas (verde) da roça. Venda por unidade.','Queijo Minas (verde)',15),(5,'Ovos capira frescos. Venda por dúzia.','Ovos caipira',8);
...
INSERT INTO `telefone` VALUES (1,'27363323'),(1,'93838393'),(2,'+556130396597'),(2,'+5561992770876');
...
-- Dump completed on 2019-01-28  0:39:01
